...
const MegaMenu = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute md:-translate-x-[60%] lg:-translate-x-[45%] xl:-translate-x-[50%] sm:w-[580px] md:w-[680px] lg:w-[980px] xl:w-[1080px] 2xl:w-[1280px] bg-white rounded-2xl border-2 overflow-hidden border-zinc-300 shadow-2xl border-t border-t-zinc-300 z-50 hidden md:block pt-5 transition-all duration-300 ease-out transform ${
          open
      ...
      >
        <div className="max-w-[1280px] mx-auto px-6 py-6 grid grid-cols-4 gap-6">
          ...
          <div
            className="relative bg-primary  rounded-lg p-6 flex flex-col items-center justify-center"
            style={{ backgroundImage: "url('/mega-menu.png')" }}
          >
            <h4 className="text-lg font-bold text-primary">Hot Deals</h4>
            <p className="text-sm mt-2 text-primary">Save up to 50% today!</p>
            <button className="mt-4 bg-white text-primary px-4 py-2 rounded-lg font-semibold duration-150 hover:bg-brand hover:text-white cursor-pointer  ">
              Shop Now
            </button>
          </div>
        </div>
        ...
        <div className="bg-gray-50 py-4 border-t">
          <div className="max-w-[1280px] mx-auto px-6 flex justify-between items-center">
            <span className="font-semibold text-sm">Subscribe for updates</span>
            <div className="flex">
              <input
                type="email"
              ...
              />
              <button className="bg-brand text-white px-4 py-2 rounded-r-lg text-sm cursor-pointer duration-150 button-shadow-hover hover:bg-amber-500">
                Subscribe
              </button>
            </div>
          </div>
      ...
      <div className="md:hidden">
        ...
        <div
          className={`bg-white border-b px-4 py-2 space-y-4 transition-all duration-300 ease-out transform ${
            open
              ? "opacity-100 translate-y-0"
              : "opacity-0 -translate-y-2 pointer-events-none"
          }`}
