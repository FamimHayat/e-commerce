    ...
    <div className="relative py-12 ">
      ...
      >
        <div className="bg-[#00000036] h-full ">
          <div className="pt-5 pb-5 duration-200 hover:pt-1 hover:pb-9">
            <div className="grid grid-cols-4 gap-1! px-4 justify-items-center place-items-end duration-250 h-40 ">
              <div className="m-2 text-2xl font-headerFont text-primary text-center bg-white rounded-md w-fit py-2 2xl:py-2 px-2 2xl:px-4">
                <p>00</p>
            ...
            <div className="absolute  shadow-2xl bg-white rounded-2xl mt-5 p-5 w-full h-fit">
