...
const BannerSliderTag = () => {
  return (
    <div className=" p-2! absolute h-full w-full flex flex-col lg:mt-15 font-headerFont items-center xl:items-start justify-center xl:justify-start ">
      <div className="p-3 sm:p-0 xl:p-20">
        ...
        <>
          <div className="relative mt-7 md:mt-10 lg:mt-15 w-[320px] md:w-[480px] bg-gray-100 rounded-2xl shadow-md p-1.5 transition-all duration-150 ease-in-out hover:shadow-lg">
            <input
              type="text"
              className="w-full px-1 sm:pl-4   sm:pr-35  py-3 text-base text-gray-700 bg-transparent rounded-lg focus:outline-none"
